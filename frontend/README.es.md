...
Este paquete contiene la aplicación web construida con [Nuxt 3](https://nuxt.com/), diseñada para conectarse de forma segura a [`navi-core`](../navi-core/README.es.md). Se distribuye como **PWA** (Progressive Web App) instalable en iOS, Android y escritorio, y el código sigue preparado para poder empaquetarse posteriormente como aplicación nativa mediante [Tauri v2](https://v2.tauri.app/) si fuera necesario.
...
Consulta [`DESIGN.es.md`](./DESIGN.es.md) para conocer el sistema de diseño "Analogue Blueprint": principios visuales, paleta de color, tipografía, espaciado y componentes base.
